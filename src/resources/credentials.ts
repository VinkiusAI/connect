...
export class CredentialsClient {
  ...
  status(opts: RequestOptions = {}): Promise<CredentialStatus> {
    return this.http.get<CredentialStatus>(this.base(), { signal: opts.signal, idempotencyKey: opts.idempotencyKey });
  }
  ...
  set(input: SetCredentialsInput, opts: RequestOptions = {}): Promise<CredentialStatus> {
    return this.http.put<CredentialStatus>(this.base(), input, { signal: opts.signal, idempotencyKey: opts.idempotencyKey });
  }
}
